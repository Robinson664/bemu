...
namespace BEmu3
{
    public abstract class Message
    {
        ...
        {
            get { throw new NotImplementedException("BEmu3.Message.AsElement is not implemented for this message type"); }
        }
        ...
        {
            get { throw new NotImplementedException("BEmu3.Message.this[string, int]: is not implemented"); }
        }
        ...
        {
            get { throw new NotImplementedException("BEmu3.Message.NumElements is not implemented for this message type"); }
        }

        public virtual string TopicName
        {
            get { throw new NotImplementedException("BEmu3.Message.TopicName is not implemented for this message type"); }
        }
