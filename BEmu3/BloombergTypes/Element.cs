...
namespace BEmu3
{
    public abstract class Element
    {
        ...
        {
            throw new NotImplementedException("Element is not a simple object");
        }
        ...
        {
            throw new NotImplementedException("Element doesn't support getting values as elements");
        }
        ...
        public virtual void SetElement(Name name, object value)
        {
