...
{
    public class RequestHistoric : Request
    {
        ...
        public override Element this[string elementName]
        {
            get
            {
                if (this._securities.Name.ToString().ToLower() == elementName.ToLower())
                    ...
                    throw new NotImplementedException("BEmu3.HistoricalDataRequest.RequestReference: public Element this[string elementName] not supported");
            }
        }
        ...
        private List<DateTime> GetDatesBeforeMaxPoints()
        {
            ...
            DateTime dtStart = this._dtStart.GetDate.GetValueOrDefault(DateTime.Today.AddYears(-1)); //BEmu3.Session.SendRequest assures that dtStart is not null
        ...
        public override void Append(string name, string elementValue)
        {
            switch (name.ToLower())
            {
                ...
                case "fields":
                    ...
                    break;
                default:
                    throw new ArgumentException(string.Format("BEmu3.RequestHistoric.Append: Element name {0} not supported", name));
            }
        }
            ...
            switch (name.ToString().ToLower())
            {
                case "startdate":
                    if (DateTime.TryParseExact(elementValue, "yyyyMMdd", System.Globalization.CultureInfo.InvariantCulture, System.Globalization.DateTimeStyles.None, out dtTemp))
                        ...
                        throw new ArgumentException(string.Format("BEmu3.Request.Set: Bad startDate format {0}, yyyyMMdd expected", elementValue));
                    break;
                case "enddate":
                    if (DateTime.TryParseExact(elementValue, "yyyyMMdd", System.Globalization.CultureInfo.InvariantCulture, System.Globalization.DateTimeStyles.None, out dtTemp))
                        this._dtEnd = new RequestHistoricElementDate("endDate", dtTemp);
                    else
                        throw new ArgumentException(string.Format("BEmu3.Request.Set: Bad endDate format {0}, yyyyMMdd expected", elementValue));
                    break;
                case "periodicityadjustment":
                    ...
                    switch (pAdjUpper)
                    {
                        ...
                        case "ACTUAL":
                            ...
                            break;
                        default:
                            throw new ArgumentException(string.Format("BEmu3.Request.Set: unknown value ({0}) for periodicityadjustment", elementValue));
                    }
                ...
                case "periodicityselection":
                    ...
                    switch (pUpper)
                    {
                        ...
                        case "DAILY":
                            ...
                            break;
                        default:
                            throw new ArgumentException(string.Format("BEmu3.Request.Set: unknown value ({0}) for periodicityselection", elementValue));
                    }
                ...
                case "pricingoption":
                    ...
                    switch (prUpper)
                    {
                        ...
                        case "PRICING_OPTION_PRICE":
                            ...
                            break;
                        default:
                            throw new ArgumentException(string.Format("BEmu3.Request.Set: unknown value ({0}) for pricingOption", elementValue));
                    }
                ...
                case "overrideoption":
                    ...
                    switch (strOpt)
                    {
                        ...
                        case "OVERRIDE_OPTION_CLOSE":
                            ...
                            break;
                        default:
                            throw new ArgumentException(string.Format("BEmu3.Request.Set: unknown value ({0}) for overrideoption", elementValue));
                    }
                    this._overrideOptionsElement = new RequestHistoricElementString("overrideOption", strOpt);
                    break;

                default:
                    throw new ArgumentException(string.Format("BEmu3.Request.Set: Element name {0} not supported", name));
            }
        }
