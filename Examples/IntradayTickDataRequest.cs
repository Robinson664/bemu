...
namespace Examples
{
    ...
    public static class IntradayTickDataRequest
    {
        ...
        public static void RunExample()
        {
            ...
            request.Set("startDateTime", new Datetime(DateTime.Today.AddDays(-1).AddHours(9.5999).ToUniversalTime()));
            request.Set("endDateTime", new Datetime(DateTime.Today.AddDays(-1).AddHours(9.6).ToUniversalTime())); //goes back at most 140 days (documentation section 7.2.3)
