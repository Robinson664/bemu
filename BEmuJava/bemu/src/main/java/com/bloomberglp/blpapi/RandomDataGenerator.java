//------------------------------------------------------------------------------
// <copyright project="BEmu_maven" file="/BEmu_maven/bemu/src/main/java/com/bloomberglp/blpapi/RandomDataGenerator.java" company="Jordan Robinson">
...
public class RandomDataGenerator
{
	...
	public static Object referenceDataFromFieldName(String fieldName, String security, boolean isOption, com.bloomberglp.blpapi.ReferenceRequest rreq) throws Exception
	{
        ...
        if(upper.equals("CHAIN_TICKERS"))
        {
        	...
        	else
        	{
                ...
                ReferenceElementArrayChainTickers chain = new ReferenceElementArrayChainTickers(security, numPoints, dtExp, optionality);
                result = chain;
        	}
        }
    ...
    public static com.bloomberglp.blpapi.IntradayBarTickDataType generateBarData(Datetime date)
    {
        ...
        com.bloomberglp.blpapi.IntradayBarTickDataType result = new com.bloomberglp.blpapi.IntradayBarTickDataType();
