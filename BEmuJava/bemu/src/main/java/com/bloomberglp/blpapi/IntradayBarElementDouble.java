//------------------------------------------------------------------------------
// <copyright project="BEmu_maven" file="/BEmu_maven/bemu/src/main/java/com/bloomberglp/blpapi/IntradayBarElementDouble.java" company="Jordan Robinson">
...
public class IntradayBarElementDouble extends Element
{
    private final double _value;
    private final String _name;
    private static final String VALUE_FORMAT = "%d";

    IntradayBarElementDouble(String name, double value)
    {
        this._name = name;
        this._value = value;
    }
    ...
    {
        return String.format(IntradayBarElementDouble.VALUE_FORMAT, this._value);
    }
