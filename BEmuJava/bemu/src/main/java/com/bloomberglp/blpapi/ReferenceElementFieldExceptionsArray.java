//------------------------------------------------------------------------------
// <copyright project="BEmu_maven" file="/BEmu_maven/bemu/src/main/java/com/bloomberglp/blpapi/ReferenceElementFieldExceptionsArray.java" company="Jordan Robinson">
...
public class ReferenceElementFieldExceptionsArray extends Element
{
    ...
    {
        this._exceptions = new ArrayList<ReferenceElementFieldExceptions>(badFields.size());
        for(int i = 0; i < badFields.size(); i++)
        {
            this._exceptions.add(new ReferenceElementFieldExceptions(badFields.get(i)));
        }
    }
