//------------------------------------------------------------------------------
// <copyright project="BEmu_maven" file="/BEmu_maven/bemu/src/main/java/com/bloomberglp/blpapi/ReferenceRequestElementStringArray.java" company="Jordan Robinson">
...
public class ReferenceRequestElementStringArray extends Element
{
    private final String _elementName;
    private final List<String> _values;

    ReferenceRequestElementStringArray(String elementName)
    {
