//------------------------------------------------------------------------------
// <copyright project="BEmu_maven" file="/BEmu_maven/bemu/src/main/java/com/bloomberglp/blpapi/IntradayTickElementInt.java" company="Jordan Robinson">
...
public class IntradayTickElementInt extends Element
{
    private final int _value;
    private final String _name;

    IntradayTickElementInt(String name, int value)
    {
        this._name = name;
        this._value = value;
    }
