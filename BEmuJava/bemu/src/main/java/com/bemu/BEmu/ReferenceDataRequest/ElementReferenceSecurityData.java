//------------------------------------------------------------------------------
// <copyright project="BEmuJava" file="BEmu.ReferenceDataRequest.ElementReferenceSecurityData.java" company="Jordan Robinson">
...
public class ElementReferenceSecurityData extends ElementParent
{
    ...
    private final ElementReferenceFieldExceptionsArray _elmFieldExceptions;
    private final ElementReferenceSecurityError _elmSecError;
    ...
    ElementReferenceSecurityData(String securityName, Map<String, Object> fieldData, int sequenceNumber)
    {
        ...
        if (this._isSecurityError)
        {
            ...
            this._elmFieldData = new ElementReferenceFieldData(new HashMap<String, Object>());
        }
        else
        {
            this._elmSequenceNumber = new ElementReferenceInt("sequenceNumber", sequenceNumber);
