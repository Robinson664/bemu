//------------------------------------------------------------------------------
// <copyright project="BEmuJava" file="BEmu.IntradayTickRequest.ElementIntradayTickResponseError.java" company="Jordan Robinson">
...
public class ElementIntradayTickResponseError extends ElementParent
{
    ...
    private final ElementIntradayTickString _source, _category, _message, _subCategory;
    private final ElementIntradayTickInt _code;
    ...
    ElementIntradayTickResponseError()
    {
        ...
        this._source = new ElementIntradayTickString("source", String.format("%s::%s%s", code, sourceGibberish, RandomDataGenerator.randomInt(99)));
        this._code = new ElementIntradayTickInt("code", code);
        this._category = new ElementIntradayTickString("category", "BAD_SEC");
        this._message = new ElementIntradayTickString("message", String.format("Unknown/Invalid security [nid:%s]", code));
