//------------------------------------------------------------------------------
// <copyright project="BEmuJava" file="BEmu.IntradayBarRequest.ElementIntradayBarDouble.java" company="Jordan Robinson">
...
package BEmu.IntradayBarRequest;

import BEmu.Element;
import BEmu.Name;
import java.lang.StringBuilder;

public class ElementIntradayBarDouble extends Element
{
    private final double _value;
    private final String _name;
    private static final String VALUE_FORMAT = "%d";

    ElementIntradayBarDouble(String name, double value)
    {
        this._name = name;
        this._value = value;
    }
    ...
    {
    	return super.prettyPrintHelper(tabIndent, BEmu.Types.Formats.formatDouble2NoCommas(this._value));
    }
    ...
    {
        return String.format(ElementIntradayBarDouble.VALUE_FORMAT, this._value);
    }
