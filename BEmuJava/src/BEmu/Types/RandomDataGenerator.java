...
public class RandomDataGenerator {
    ...
    public static BEmu.IntradayBarRequest.BarTickDataType GenerateBarData(Datetime date)
    {
        ...
        BEmu.IntradayBarRequest.BarTickDataType result = new BEmu.IntradayBarRequest.BarTickDataType();
