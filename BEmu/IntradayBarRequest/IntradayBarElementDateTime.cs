//------------------------------------------------------------------------------
// <copyright project="BEmu_csh" file="IntradayBarRequest/IntradayBarElementDateTime.cs" company="Jordan Robinson">
...
namespace Bloomberglp.Blpapi.IntradayBarRequest
{
    ...
    internal class IntradayBarElementDateTime : Element
    {
        private readonly Datetime _date;

        internal IntradayBarElementDateTime(DateTime date)
        {
