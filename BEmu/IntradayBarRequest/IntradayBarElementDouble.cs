//------------------------------------------------------------------------------
// <copyright project="BEmu_csh" file="IntradayBarRequest/IntradayBarElementDouble.cs" company="Jordan Robinson">
...
namespace Bloomberglp.Blpapi.IntradayBarRequest
{
    ...
    internal class IntradayBarElementDouble : Element
    {
        private readonly double _value;
        private readonly string _name;

        internal IntradayBarElementDouble(string name, double value)
        {
            this._name = name;
            this._value = value;
        }
