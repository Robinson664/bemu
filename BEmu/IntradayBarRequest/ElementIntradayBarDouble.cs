//------------------------------------------------------------------------------
// <copyright project="BEmu" file="IntradayBarRequest/ElementIntradayBarDouble.cs" company="Jordan Robinson">
...
namespace BEmu.IntradayBarRequest
{
    ...
    internal class ElementIntradayBarDouble : Element
    {
        private readonly double _value;
        private readonly string _name;

        internal ElementIntradayBarDouble(string name, double value)
        {
            this._name = name;
            this._value = value;
        }
