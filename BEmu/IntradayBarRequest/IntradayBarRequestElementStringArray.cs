//------------------------------------------------------------------------------
// <copyright project="BEmu_csh" file="IntradayBarRequest/IntradayBarRequestElementStringArray.cs" company="Jordan Robinson">
...
namespace Bloomberglp.Blpapi.IntradayBarRequest
{
    ...
    internal class IntradayBarRequestElementStringArray : Element
    {
        private readonly string _elementName;
        private readonly List<string> _values;

        internal IntradayBarRequestElementStringArray(string elementName)
        {
        ...
        {
            if (IntradayBarRequestElementStringArray._allowedEventTypes.Contains(value, StringComparer.Ordinal)) //The API is case-sensitive
