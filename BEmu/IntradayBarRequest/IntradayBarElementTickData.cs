//------------------------------------------------------------------------------
// <copyright project="BEmu_csh" file="IntradayBarRequest/IntradayBarElementTickData.cs" company="Jordan Robinson">
...
namespace Bloomberglp.Blpapi.IntradayBarRequest
{
    ...
    internal class IntradayBarElementTickData : Element
    {
        internal IntradayBarElementTickData(IntradayBarTickDataType arg)
        {
            this._time = new IntradayBarElementDateTime(arg.DtTime);
            this._open = new IntradayBarElementDouble("open", arg.Open);
            this._high = new IntradayBarElementDouble("high", arg.High);
            this._low = new IntradayBarElementDouble("low", arg.Low);
            this._close = new IntradayBarElementDouble("close", arg.Close);
            this._volume = new IntradayBarElementLong("volume", arg.Volume);
            this._numEvents = new IntradayBarElementInt("numEvents", arg.NumEvents);
            this._value = new IntradayBarElementDouble("value", arg.Value);
        }

        private readonly IntradayBarElementDateTime _time;
        private readonly IntradayBarElementDouble _open, _high, _low, _close, _value;
        private readonly IntradayBarElementLong _volume;
        private readonly IntradayBarElementInt _numEvents;
