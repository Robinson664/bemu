//------------------------------------------------------------------------------
// <copyright project="BEmu_csh" file="IntradayBarRequest/IntradayBarRequestElementInt.cs" company="Jordan Robinson">
...
namespace Bloomberglp.Blpapi.IntradayBarRequest
{
    ...
    internal class IntradayBarRequestElementInt : IntradayBarRequestElementString
    {
        private readonly int _value;

        internal IntradayBarRequestElementInt(string elementName, int value)
