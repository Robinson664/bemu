//------------------------------------------------------------------------------
// <copyright project="BEmu_csh" file="IntradayBarRequest/IntradayBarElementString.cs" company="Jordan Robinson">
...
namespace Bloomberglp.Blpapi.IntradayBarRequest
{
    ...
    internal class IntradayBarElementString : Element
    {
        private readonly string _value;
        private readonly string _name;

        internal IntradayBarElementString(string name, string value)
        {
            this._name = name;
            this._value = value;
        }
