//------------------------------------------------------------------------------
// <copyright project="BEmu" file="IntradayTickRequest/RequestIntradayTickElementStringArray.cs" company="Jordan Robinson">
...
namespace BEmu.IntradayTickRequest
{
    ...
    internal class RequestIntradayTickElementStringArray : Element
    {
        private readonly string _elementName;
        private readonly List<string> _values;

        internal RequestIntradayTickElementStringArray(string elementName)
        {
