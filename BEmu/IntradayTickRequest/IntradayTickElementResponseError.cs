//------------------------------------------------------------------------------
// <copyright project="BEmu_csh" file="IntradayTickRequest/IntradayTickElementResponseError.cs" company="Jordan Robinson">
...
namespace Bloomberglp.Blpapi.IntradayTickRequest
{
    ...
    internal class IntradayTickElementResponseError : Element
    {
        private readonly IntradayTickElementString _source, _category, _message, _subCategory;
        private readonly IntradayTickElementInt _code;
