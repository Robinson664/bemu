//------------------------------------------------------------------------------
// <copyright project="BEmu" file="IntradayTickRequest/ElementIntradayTickDateTime.cs" company="Jordan Robinson">
...
namespace BEmu.IntradayTickRequest
{
    ...
    internal class ElementIntradayTickDateTime : Element
    {
        private readonly Datetime _date;

        internal ElementIntradayTickDateTime(DateTime date)
        {
