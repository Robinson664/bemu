//------------------------------------------------------------------------------
// <copyright project="BEmu_csh" file="IntradayTickRequest/IntradayTickElementInt.cs" company="Jordan Robinson">
...
namespace Bloomberglp.Blpapi.IntradayTickRequest
{
    ...
    internal class IntradayTickElementInt : Element
    {
        private readonly int _value;
        private readonly string _name;

        internal IntradayTickElementInt(string name, int value)
        {
            this._name = name;
            this._value = value;
        }
