//------------------------------------------------------------------------------
// <copyright project="BEmu_csh" file="IntradayTickRequest/IntradayTickElementDouble.cs" company="Jordan Robinson">
...
namespace Bloomberglp.Blpapi.IntradayTickRequest
{
    ...
    internal class IntradayTickElementDouble : Element
    {
        private readonly double _value;
        private readonly string _name;

        internal IntradayTickElementDouble(string name, double value)
        {
            this._name = name;
            this._value = value;
        }
