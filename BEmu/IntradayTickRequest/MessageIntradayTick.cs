...
namespace BEmu.IntradayTickRequest
{
    ...
    internal class MessageIntradayTick : Message
    {
        ...
        internal MessageIntradayTick(CorrelationID corr, Service service, SortedDictionary<DateTime, BEmu.Types.Tuple3<string, double, int>> ticks, bool includeConditionCodes) :
