//------------------------------------------------------------------------------
// <copyright project="BEmu_csh" file="MarketDataRequest/MarketElementBool.cs" company="Jordan Robinson">
...
namespace Bloomberglp.Blpapi.MarketDataRequest
{
    ...
    internal class MarketElementBool : Element
    {
        private readonly bool _value;
        private readonly string _name;

        internal MarketElementBool(string name, bool value)
        {
            this._name = name;
            this._value = value;
        }
