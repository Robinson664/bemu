//------------------------------------------------------------------------------
// <copyright project="BEmu_csh" file="MarketDataRequest/MarketElementString.cs" company="Jordan Robinson">
...
namespace Bloomberglp.Blpapi.MarketDataRequest
{
    ...
    internal class MarketElementString : Element
    {
        private readonly string _name, _value;

        internal MarketElementString(string name, string value)
        {
            this._name = name;
            this._value = value;
        }
