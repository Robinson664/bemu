//------------------------------------------------------------------------------
// <copyright project="BEmu_csh" file="MarketDataRequest/MarketElementDatetime.cs" company="Jordan Robinson">
...
namespace Bloomberglp.Blpapi.MarketDataRequest
{
    ...
    internal class MarketElementDatetime : Element
    {
        private readonly Datetime _datetime;
        private readonly string _name;

        internal MarketElementDatetime(string name, DateTime datetime)
        {
            this._name = name;
