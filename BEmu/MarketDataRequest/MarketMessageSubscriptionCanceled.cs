//------------------------------------------------------------------------------
// <copyright project="BEmu_csh" file="MarketDataRequest/MarketMessageSubscriptionCanceled.cs" company="Jordan Robinson">
...
namespace Bloomberglp.Blpapi.MarketDataRequest
{
    ...
    internal class MarketMessageSubscriptionCanceled : Message
    {
        private readonly string _topicName;
        private readonly MarketElementSubscriptionCancelReason _reason;

        internal MarketMessageSubscriptionCanceled(Subscription sub) : base(new Name("SubscriptionTerminated"), sub.CorrelationID, null)
        {
