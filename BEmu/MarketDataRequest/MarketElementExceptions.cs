//------------------------------------------------------------------------------
// <copyright project="BEmu_csh" file="MarketDataRequest/MarketElementExceptions.cs" company="Jordan Robinson">
...
namespace Bloomberglp.Blpapi.MarketDataRequest
{
    ...
    internal class MarketElementExceptions : Element
    {
        private readonly MarketElementString _fieldId;
