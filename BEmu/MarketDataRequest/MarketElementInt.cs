//------------------------------------------------------------------------------
// <copyright project="BEmu_csh" file="MarketDataRequest/MarketElementInt.cs" company="Jordan Robinson">
...
namespace Bloomberglp.Blpapi.MarketDataRequest
{
    ...
    internal class MarketElementInt : Element
    {
        private readonly int _value;
        private readonly string _name;

        internal MarketElementInt(string name, int value)
        {
            this._name = name;
            this._value = value;
        }
