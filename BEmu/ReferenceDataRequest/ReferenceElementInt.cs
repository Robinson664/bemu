//------------------------------------------------------------------------------
// <copyright project="BEmu_csh" file="ReferenceDataRequest/ReferenceElementInt.cs" company="Jordan Robinson">
...
namespace Bloomberglp.Blpapi.ReferenceDataRequest
{
    ...
    internal class ReferenceElementInt : Element
    {
        private readonly int _value;
        private readonly string _name;

        internal ReferenceElementInt(string name, int value)
        {
            this._name = name;
            this._value = value;
        }
