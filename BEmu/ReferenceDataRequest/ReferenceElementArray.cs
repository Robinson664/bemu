//------------------------------------------------------------------------------
// <copyright project="BEmu_csh" file="ReferenceDataRequest/ReferenceElementArray.cs" company="Jordan Robinson">
...
namespace Bloomberglp.Blpapi.ReferenceDataRequest
{
    ...
    internal class ReferenceElementArray : Element
    {
        protected readonly List<Element> _values;
        private readonly string _name;

        internal ReferenceElementArray(string name, List<Element> elements)
        {
            this._name = name;
