//------------------------------------------------------------------------------
// <copyright project="BEmu_csh" file="ReferenceDataRequest/ReferenceElementFieldExceptionsArray.cs" company="Jordan Robinson">
...
namespace Bloomberglp.Blpapi.ReferenceDataRequest
{
    ...
    internal class ReferenceElementFieldExceptionsArray : Element
    {
        private readonly List<ReferenceElementFieldExceptions> _exceptions;

        public ReferenceElementFieldExceptionsArray(List<string> badFields)
        {
            this._exceptions = new List<ReferenceElementFieldExceptions>(badFields.Count);
            foreach (var item in badFields)
            {
                this._exceptions.Add(new ReferenceElementFieldExceptions(item));
            }
        }
