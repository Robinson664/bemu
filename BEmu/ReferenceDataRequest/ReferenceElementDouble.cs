//------------------------------------------------------------------------------
// <copyright project="BEmu_csh" file="ReferenceDataRequest/ReferenceElementDouble.cs" company="Jordan Robinson">
...
namespace Bloomberglp.Blpapi.ReferenceDataRequest
{
    ...
    internal class ReferenceElementDouble : Element
    {
        private readonly double _value;
        private readonly string _name;

        internal ReferenceElementDouble(string name, double value)
        {
            this._name = name;
            this._value = value;
        }
