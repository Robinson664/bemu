//------------------------------------------------------------------------------
// <copyright project="BEmu_csh" file="ReferenceDataRequest/ReferenceRequestElementStringArray.cs" company="Jordan Robinson">
...
namespace Bloomberglp.Blpapi.ReferenceDataRequest
{
    ...
    internal class ReferenceRequestElementStringArray : Element
    {
        private readonly string _elementName;
        private readonly List<string> _values;

        internal ReferenceRequestElementStringArray(string elementName)
        {
