//------------------------------------------------------------------------------
// <copyright project="BEmu" file="ReferenceDataRequest/ElementReferenceFieldExceptionsArray.cs" company="Jordan Robinson">
...
namespace BEmu.ReferenceDataRequest
{
    ...
    internal class ElementReferenceFieldExceptionsArray : Element
    {
        private readonly List<ElementReferenceFieldExceptions> _exceptions;

        public ElementReferenceFieldExceptionsArray(List<string> badFields)
        {
            this._exceptions = new List<ElementReferenceFieldExceptions>(badFields.Count);
            foreach (var item in badFields)
            {
                this._exceptions.Add(new ElementReferenceFieldExceptions(item));
            }
        }
