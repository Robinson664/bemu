//------------------------------------------------------------------------------
// <copyright project="BEmu" file="HistoricalDataRequest/ElementHistoricFieldExceptions.cs" company="Jordan Robinson">
...
namespace BEmu.HistoricalDataRequest
{
    ...
    internal class ElementHistoricFieldExceptions : Element
    {
        private readonly ElementHistoricString _fieldId;
        private readonly ElementHistoricErrorInfo _errorInfo;
