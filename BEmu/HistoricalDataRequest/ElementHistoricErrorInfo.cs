//------------------------------------------------------------------------------
// <copyright project="BEmu" file="HistoricalDataRequest/ElementHistoricErrorInfo.cs" company="Jordan Robinson">
...
namespace BEmu.HistoricalDataRequest
{
    ...
    internal class ElementHistoricErrorInfo : Element
    {
        private readonly ElementHistoricString _source, _category, _message, _subCategory;
        private readonly ElementHistoricInt _code;
