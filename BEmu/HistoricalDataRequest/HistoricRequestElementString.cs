//------------------------------------------------------------------------------
// <copyright project="BEmu_csh" file="HistoricalDataRequest/HistoricRequestElementString.cs" company="Jordan Robinson">
...
namespace Bloomberglp.Blpapi.HistoricalDataRequest
{
    ...
    internal class HistoricRequestElementString : Element
    {
        private readonly string _elementName, _value;

        internal HistoricRequestElementString(string elementName, string value)
        {
