//------------------------------------------------------------------------------
// <copyright project="BEmu_csh" file="HistoricalDataRequest/HistoricElementFieldExceptions.cs" company="Jordan Robinson">
...
namespace Bloomberglp.Blpapi.HistoricalDataRequest
{
    ...
    internal class HistoricElementFieldExceptions : Element
    {
        private readonly HistoricElementString _fieldId;
        private readonly HistoricElementErrorInfo _errorInfo;
