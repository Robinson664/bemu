//------------------------------------------------------------------------------
// <copyright project="BEmu_csh" file="HistoricalDataRequest/HistoricRequestElementStringArray.cs" company="Jordan Robinson">
...
namespace Bloomberglp.Blpapi.HistoricalDataRequest
{
    ...
    internal class HistoricRequestElementStringArray : Element
    {
        private readonly string _elementName;
        private readonly List<string> _values;

        internal HistoricRequestElementStringArray(string elementName)
        {
