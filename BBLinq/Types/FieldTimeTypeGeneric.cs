...
{
    public class FieldTimeType<T> : FieldDateTypeParent<T>
    {
        internal FieldTimeType(string bbKey, string fieldName, DateTime date) : base(bbKey, fieldName, date)
        {
        }

        internal FieldTimeType(string bbKey, string fieldName, T value, DateTime date) : base(bbKey, fieldName, value, date)
        {
        }
